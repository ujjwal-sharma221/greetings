  ...
  },
  {
    ...
    component: ({ className, ...props }) => (
      <button
        {...props}
        className={cn(
          "border-border bg-main-background relative rounded-xl border px-4 py-2 transition-all duration-200",
  ...
  },
  {
    ...
    component: ({ className, ...props }) => (
      <button
        {...props}
        className={cn(
          "animate-shine border-border items-center justify-center rounded-xl border bg-[length:400%_100%]",
          "text-primary-invert/90 dark:text-primary-muted px-4 py-2 transition-colors",
  ...
  },
  {
    ...
    component: ({ children, className, ...props }) => (
      <button
        {...props}
        className={cn(
          "border-primary/10 bg-main-background hover:bg-main-foreground/40 relative rounded-xl border px-4 py-2 duration-200",
          className,
        )}
      >
        <div
        ...
        <span className="text-primary-muted relative z-10">{children}</span>
      </button>
    ),
  },
  {
    ...
    component: ({ children, className, ...props }) => (
      ...
      >
        ...
        <span
          className={cn(
            "bg-main-background text-primary-foreground inline-flex size-full items-center justify-center rounded-[11px] px-4 py-2 backdrop-blur-3xl",
            className,
          )}
        >
          {children}
    ...
    component: ({ children, className, ...props }) => {
      return (
        <button
          {...props}
          className={cn(
            "group text-primary-invert relative overflow-hidden rounded-xl px-4 py-2 duration-300",
